...
loglikelihood(d::AbstractQDIM, data::Tuple; t = π / 2) = sum(logpdf.(d, data...; t))

function loglikelihood(
    model::AbstractQDIM,
    outcomes1::Vector{<:Vector{<:Real}},
    outcomes2::Vector{<:Vector{<:Real}},
    won_first::Vector{Bool},
    data::Vector{<:Vector{<:Int}};
    t = π / 2
)
    return sum(logpdf.(model, outcomes1, outcomes2, won_first, data; t))
end
